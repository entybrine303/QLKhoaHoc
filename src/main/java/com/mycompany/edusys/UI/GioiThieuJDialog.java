...
public class GioiThieuJDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/mycompany/edusys/icon/logofpt.png"))); // NOI18N

        txtIntro.setEditable(false);
        txtIntro.setBackground(new java.awt.Color(255, 255, 255));
        txtIntro.setText("Polypro là dự án mẫu. Mục tiêu chính là huấn luyện sinh viên quy trình thực hiện dự án.\n\nMục tiêu của dự án này là để rèn luyện kỹ năng IO(CDIO) tức không yêu cầu sinh viên phải thu thập phân tích mà chỉ thực hiện và vận hành một phần mềm chuẩn bị cho các dự án sau này. Các kỹ năng CD(trong CDIO) sẽ được huấn luyện trông dự án 1 và dự án 2.\n\nYêu cầu môi trường:\n1. Hệ điều hành bất kỳ\n2. JDK 1.8 trở lên \n3.SQL Server 2008 trở lên");
